...
STOW_PACKAGES=(shell alacritty niri waybar pipewire obs mako fuzzel swaylock xremap fcitx5 wayland-flags git tig yazi systemd-user scripts wallpaper gtk)
